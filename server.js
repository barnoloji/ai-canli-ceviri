...
app.use(express.static(path.join(__dirname, 'live-translation-frontend/dist')));

// SPA için tüm route'ları index.html'e yönlendir
app.get('*', (req, res) => {
  res.sendFile(path.join(__dirname, 'live-translation-frontend/dist/index.html'));
});
...
server.listen(PORT, '0.0.0.0', () => {
  ...
  console.log(`\n✨ Uygulama hazır: http://localhost:${PORT}`);
});
